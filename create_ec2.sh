...
main() {
    ...
    AMI_ID="" # -> Your EC2 Instance AMI ID. Can be any OS i.e. Ubuntu, Amazon Linux, etc.
    INSTANCE_TYPE="t2.micro" #Your EC2 Instance type.
    KEY_NAME="" #Add a key-pair.
    SUBNET_ID="" #Add the subnet ID
    SECURITY_GROUP_IDS=""  # Add your security group IDs separated by space
    INSTANCE_NAME="Sample-EC2" #Add a name for your EC2 instance
